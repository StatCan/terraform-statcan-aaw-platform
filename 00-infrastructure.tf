...
module "platform_infrastructure" {
  source = "git::https://gitlab.k8s.cloud.statcan.ca/cloudnative/terraform/modules/terraform-statcan-azure-cloud-native-platform-infrastructure.git?ref=v1.0.0"
